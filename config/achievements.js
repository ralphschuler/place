...
module.exports = [
    ...
    },
    {
        ...
        imageURL: `battery-three-quarters`,
        meetsCriteria(user) {
    ...
    {
        name: "Addict",
        description: "People can safely default to assuming you're on pixel",
        imageURL: `battery-half`,
        meetsCriteria(user) {
    ...
    {
        name: "Ultra-Addict",
        description: "You play pixel so much, you should just run the website.",
        imageURL: `battery-empty`,
        meetsCriteria(user) {
